	...
	const faqs = [
		{
			...
			answer:
				"To submit a complaint, click on the 'Submit New Complaint' button in the navigation menu. Fill out the complaint form with details about your issue, select the appropriate category and department, and click submit.",
		},
		{
			question: "Can I submit an anonymous complaint?",
			answer:
				"Yes, when submitting a complaint, you can check the 'Submit anonymously' option. Your name will not be visible to administrators, but they can still respond to your complaint.",
		},
		{
			question: "How can I track my complaint's status?",
			answer:
				"All your submitted complaints appear on your dashboard. Each complaint card shows its current status, and you'll receive notifications when there are updates.",
		},
		{
			question: "What do the different status types mean?",
			answer:
				"Pending: Newly submitted complaint\nUnder Review: Being evaluated by admin\nIn Progress: Action being taken\nResolved: Issue has been addressed\nRejected: Complaint cannot be processed",
		},
		{
			question: "How do I provide feedback?",
			answer:
				"Once your complaint is marked as resolved, you'll see a 'Provide Feedback' button on the complaint card. Click it to rate the resolution and leave comments.",
		},
	];
	...
	const guides = [
		{
			...
			content:
				"Learn how to use the University Complaint Box system effectively.",
		},
		{
